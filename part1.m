...
thresh = 0.001;
rgb_thresh = 0.055;
[R_h,R_h_good] = decode([scandir 'r_'],1,10,thresh,rgb_thresh);
[R_v,R_v_good] = decode([scandir 'r_'],11,20,thresh,rgb_thresh);
[L_h,L_h_good] = decode([scandir 'l_'],1,20,thresh,rgb_thresh);
[L_v,L_v_good] = decode([scandir 'l_'],11,20,thresh,rgb_thresh);
%
...
% and were visible in both the left anda right images
%
